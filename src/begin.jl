function newav(d::DataBase, tg, ms)
    ...
    msg = string("Sveiki/Здравствуйте, ", kas2nkas(av["first_name"]), "! Esu robotas Talkon. Aš padedu kaip taksi išsikviesti (arba suteikti) bendruomenės pagalbą./Я робот Talkon. Я допомагаю як таксі викликати (або надати) допомогу./Я робот Талкон. Помогаю как такси вызвать (или оказать) помощь.")
